        ...
        return (
            <div style={{ backgroundColor: 'white', border: '1px solid #ccc', borderRadius: '16px', marginBottom: '20px', padding: '20px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                    ...
                    {onDelete && <button onClick={() => onDelete(meal.id)} style={{ padding: '5px', borderRadius: '50%' }}>{DeleteIcon}</button>}
                </div>
                
                <div style={{ display: 'flex', alignItems: 'center', gap: '20px', padding: '10px 0' }}>
                    <img src={meal.image || '/path/to/default/meal.png'} alt={meal.name} style={{ width: '140px', height: '120px', objectFit: 'cover', borderRadius: '18px' }} />
                    <div>
